...
function DemoHome() {
    ...
    return (
        <>
            ...
            <div  className='d-flex justify-content-center p-3'><h1 style={{fontSize:'50px',fontFamily:''}} className='headding'>Docs App</h1></div>
                {/* ADD BUTTON AND MODAL */}
                <Button variant="success" className='fw-bolder  mt-4 ms-5 btn shadow ' onClick={handleShowAdd}>
                            ...
                            <Card className='shadow'>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        ...
                                        <div dangerouslySetInnerHTML={{ __html: values.name2.slice(0,2500) }} />
